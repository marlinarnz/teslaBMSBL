...
#define ROUGH_BALANCE_V_SETPOINT 3.8f
...
#define COOLING_LOWT_SETPOINT 20.0f  //threashold at wich coolant pump gradually increases duty up to max.
#define COOLING_HIGHT_SETPOINT 32.0f //threshold at wich coolant pump is at maximum duty
// Temperatures in °C
#define OVER_T_SETPOINT 45.0f       //Tesla seam to allow reaching 45C while supercharging
#define UNDER_T_SETPOINT -10.0f
#define UNDER_T_CHARGE_SETPOINT 0.0f
...
// charge amperage
#define MAX_CHARGE_A_SETPOINT 12.0f
#define MIN_CHARGE_A_SETPOINT 3.0f
// reduce charger amperage at high average cell voltages (unit: ampere per volt)
#define CHARGE_A_REDUCTION_FACTOR_VOLT 100.0f
// reduce charger amperage at low/high min/max cell temperatures (unit: ampere per degree)
#define CHARGE_A_REDUCTION_FACTOR_LOWTEMP MAX_CHARGE_A_SETPOINT / (HEATING_T_SETPOINT - UNDER_T_CHARGE_SETPOINT)
#define CHARGE_A_REDUCTION_FACTOR_HIGHTEMP MAX_CHARGE_A_SETPOINT / (OVER_T_SETPOINT - COOLING_HIGHT_SETPOINT)
